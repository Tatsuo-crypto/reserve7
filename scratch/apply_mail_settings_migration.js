...
async function applyMailSettingsMigration() {
  try {
    console.log('Applying mail_settings table migration via exec_sql RPC...')
    ...
    const sql = `
      ...
      CREATE TABLE IF NOT EXISTS mail_settings (
        ...
        additional_recipient_emails TEXT DEFAULT '',
...
URL：{url}';
    ...
    console.log('✅ mail_settings table successfully created and columns verified/updated!')
    ...
    if (selectError) {
      console.error('❌ Verification check failed:', selectError)
      process.exit(1)
    }

    console.log('✅ Verification successful! Current mail_settings:', settings)
  } catch (err) {
