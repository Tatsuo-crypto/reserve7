        ...
        <div className="px-6 py-5">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              ...
              className="inline-flex items-center px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-800 border border-gray-300 rounded-md text-sm font-medium transition-colors"
            >
