            ...
            <div key={trainer.id} className="rounded-2xl border border-border-subtle bg-surface-base px-4 py-3">
              <div className="mb-3 flex items-center justify-between gap-3">
                ...
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-brand-500/15 text-brand-600 active:scale-95"
          ...
          <>
            {selectionMode && (
              <div className="flex items-center justify-center gap-2 border-b border-border-subtle px-4 py-3">
                <span className="rounded-full bg-brand-500/15 px-3 py-2 text-sm text-brand-600">{selectedShiftIds.length}件</span>
                <Button
                  type="button"
                  variant="destructive"
