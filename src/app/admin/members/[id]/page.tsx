        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-10">
          ...
          {member.accessToken ? (
            ...
            >
              ...
              <span className="text-sm font-black text-gray-900 tracking-tight">{copySuccess || 'URLをコピー'}</span>
            ...
            <div className="bg-gray-50/50 p-6 rounded-3xl shadow-sm border border-gray-100 flex flex-col items-center justify-center opacity-50 cursor-not-allowed">
              ...
              <span className="text-sm font-black text-gray-400">URL未設定</span>
            </div>
          )}
          ...
          >
            ...
            <span className="text-sm font-black text-gray-900 tracking-tight">会員情報</span>
          ...
          {member.accessToken ? (
            ...
            >
              ...
              <span className="text-sm font-black text-gray-900 tracking-tight">会員画面確認</span>
          ...
          >
            ...
            <span className="text-sm font-black text-gray-900 tracking-tight">月額プラン</span>
