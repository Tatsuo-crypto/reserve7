                ...
                <div className="absolute right-0 mt-2 w-40 bg-surface-raised rounded-2xl shadow-xl py-1 z-50 border border-border-subtle animate-fadeIn overflow-hidden">
                    ...
                    {stores.map(store => (
                        <Button
                            ...
                            className={`block w-full text-left px-4 py-3 text-sm text-text-secondary hover:bg-surface-overlay transition-colors ${store.name === currentStoreName ? 'bg-surface-overlay text-brand-600' : ''
                                }`}
                        >
