    ...
    <div className="min-h-screen flex flex-col bg-surface-base pt-20 pb-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full mx-auto space-y-4">
        ...
        <div className="rounded-lg bg-red-500/15 p-4">
          <div className="flex">
            <div className="flex-shrink-0">
              <Icon name="xCircle" size={20} className="text-red-700" />
            </div>
            <div className="ml-3">
        ...
        <div className="text-center">
          <Link 
            href="/login" 
            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-normal rounded-lg text-white bg-brand-500 hover:bg-brand-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500"
          >
            ログインページに戻る
          </Link>
        </div>
